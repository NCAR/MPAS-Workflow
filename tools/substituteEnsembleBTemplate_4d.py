...
# usage:
# python substituteEnsembleB_4d.py stateFiles yamlFiles substitutionString nIndent SelfExclusion

def substituteEnsembleB_4d():
  # Parse command line
...
if __name__ == '__main__': substituteEnsembleB_4d()
