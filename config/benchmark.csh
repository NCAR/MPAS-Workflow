...
# BenchmarkExperimentDirectory could be set in a separate config file generated by the cron job, then that config
# file gets sourced in config/filestructure.csh and used by the archiving program.  For now, here is an example:
set BenchmarkExperimentDirectory = /glade/scratch/${USER}/pandac/${USER}_3denvar_OIE120km
