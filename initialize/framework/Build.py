  ...
  def __init__(self, config:Config, model:Model=None):
    ...
    if system == 'derecho':
      self.variablesWithDefaults['mpas bundle'] = \
        ['/glade/campaign/mmm/parc/ivette/pandac/codeBuild/mpasBundle_2.1_SP_cloud-seeding/mpas-bundle/build2', str]
    ...
    self._set('SACABuildDir', '/glade/derecho/scratch/bjung/saca/mpas-bundle.modif2_bugfix.traj_fix.NoCloudBuilding/build_single/bin')
