...
are selected via `drivers/Cycle.csh` are generated by performing sed substitution within
`SetupWorkflow.csh` and `AppAndVerify.csh`. Here we give a brief summary of the design and
templating for each script.
