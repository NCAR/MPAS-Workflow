...
while ( $member <= ${nMembers} )
  ...
  rm ${anFile}
  cp -v ${bgFile} ${anFile}
#  ncpdq -5 --pck_map=dbl_flt ${bgFile} ${anFile} 
...
# substitutions
# Just set the current BG directory

# substitute Jb members
setenv myCommand "${substituteEnsembleBTemplate} ${self_WorkDir}/${backgroundSubDir} None ${ensPbMemPrefix} ${BGFilePrefix}.${thisMPASFileDate}.nc ${ensPbMemNDigits} ${ensPbNMembers} $yamlFiles ${enspbmemsed} ${nEnsIndent} False"
...
## generating yaml file for OMA diagnosis
# ===========================
set yamlFiles = enkfs.txt
echo $diagyaml > $yamlFiles
## yaml indentation
set nEnsIndent = 2
...
# substitute Jb members
setenv myCommand "${substituteEnsembleBTemplate} ${self_WorkDir}/${analysisSubDir} None ${ensPbMemPrefix} ${ANFilePrefix}.${thisMPASFileDate}.nc ${ensPbMemNDigits} ${ensPbNMembers} $yamlFiles ${enspbmemsed} ${nEnsIndent} False"
