...
rm -f ./test/tmp/GEFSRealtime_${CYCLE_TIME}.yaml
sed -f script.sed ./test/GenerateGEFS.yaml > ./test/tmp/GEFSRealtime_${CYCLE_TIME}.yaml

# Run the Python script
./Run.py test/tmp/GEFSRealtime_${CYCLE_TIME}.yaml
